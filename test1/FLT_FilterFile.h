...
public:
    ...
    /* Splits the signal into blocks and filters. It is used on 
    signals of any magnitude, it is effective in processing 
    large sequences
    ...
    */
    ...
    /* Splits the signal into blocks and filters. It is used on
    signals of any magnitude, it is effective in processing
    large sequences, returns signal with impulse response (tails)
    ...
    */
    int filtrateBlockT(double* const signal, double* &output, int length, int accurancy);
